...
INSERT INTO facilities(id, description, number_of_rooms, published_date_time, total_area, month_rent, price, status, client_id) VALUES(2, 'barbershop, ready business model', 3, '2020-04-27 19:53:26.298205', 200, 4200.00, 1500000.00, 'FOR_SALE', 3);
INSERT INTO basements(id, it_commercial) VALUES(2, true);

INSERT INTO facilities(id, description, number_of_rooms, published_date_time, total_area, month_rent, price, status, client_id) VALUES(3, 'vehicles repair', 3, '2020-04-27 19:53:26.298205', 600, 6000.00, 2000000.00, 'FOR_SALE', 3);
INSERT INTO garages(id, has_equipment, has_pit) VALUES(3, true, true);

INSERT INTO facilities(id, description, number_of_rooms, published_date_time, total_area, month_rent, price, status, client_id) VALUES(4, 'new home with repair for big family', 8, '2020-04-27 19:53:26.298205', 300, 3000.00, 700000.00, 'RENTED', 4);
INSERT INTO houses(id, has_backyard, has_garden, number_of_storeys) VALUES(4, true, true, 3);

INSERT INTO facilities(id, description, number_of_rooms, published_date_time, total_area, month_rent, price, status, client_id) VALUES(5, 'huge storage for drug dealers', 3, '2020-04-27 19:53:26.298205', 700, 5000.00, 1200000.00, 'SOLD', 5);
